class Solution:
    def minWindow(self, s: str, t: str) -> str:
        ...
        Strategy: Sliding Window with have/need counters
        - Expand window from the right until it contains all characters of t.
        - Shrink window from the left while it stays valid.
        ...
        # have = unique characters in window meeting required count
        # need = unique characters in t that must be satisfied
