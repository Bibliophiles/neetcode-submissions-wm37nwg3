class Solution:
    def isValidSudoku(self, board: List[List[str]]) -> bool:
        ...
        # have been seen in that row, column, or 3x3 box.
        # e.g. row_masks[0] tracks digits seen in row 0
        row_masks    = [0] * 9
        col_masks    = [0] * 9
        box_masks    = [0] * 9
